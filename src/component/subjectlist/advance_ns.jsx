      ...
      <div style={{ display: "flex" }}>
        ...
        >
          ...
          <CourseAccordion
            courseName="情報工学実験Ⅰ"
            instructors="複数名"
            syllabusLink="https://gkmsyllabus.meijo-u.ac.jp/camweb/slbssbdr.do?value(risyunen)=2023&value(semekikn)=1&value(kougicd)=642418&value(crclumcd)=12205"
          />
          <CourseAccordion
            courseName="情報工学実験Ⅱ"
            instructors="複数名"
            syllabusLink="https://gkmsyllabus.meijo-u.ac.jp/camweb/slbssbdr.do?value(risyunen)=2023&value(semekikn)=1&value(kougicd)=642817&value(crclumcd)=12205"
          />
          <CourseAccordion
            courseName="情報理論"
            instructors="複数名"
            syllabusLink="https://gkmsyllabus.meijo-u.ac.jp/camweb/slbssbdr.do?value(risyunen)=2023&value(semekikn)=1&value(kougicd)=303305&value(crclumcd)=04142"
          />
          <CourseAccordion
            courseName="データベース"
            instructors="複数名"
          ...
          <CourseAccordion
            courseName="電磁気学"
            instructors="複数名"
            syllabusLink="https://gkmsyllabus.meijo-u.ac.jp/camweb/slbssbdr.do?value(risyunen)=2023&value(semekikn)=1&value(kougicd)=642415&value(crclumcd)=12205"
          />
          <div style={{ backgroundColor: "#f16868", padding: "10px" }}>
            <CourseAccordion
      ...
      <div style={{ display: "flex" }}>
        ...
        >
          ...
          <CourseAccordion
            courseName="符号伝送論"
            instructors="複数名"
            syllabusLink="https://gkmsyllabus.meijo-u.ac.jp/camweb/slbssbdr.do?value(risyunen)=2023&value(semekikn)=1&value(kougicd)=302408&value(crclumcd)=04141"
          />
          <CourseAccordion
            courseName="電気電磁回路２"
            instructors="複数名"
            syllabusLink="https://gkmsyllabus.meijo-u.ac.jp/camweb/slbssbdr.do?value(risyunen)=2023&value(semekikn)=1&value(kougicd)=302301&value(crclumcd)=04141"
          />
          <CourseAccordion
            courseName="キャリアゼミナール"
            instructors="複数名"
          ...
          <CourseAccordion
            courseName="情報セキュリティ"
            instructors="複数名"
            syllabusLink="https://gkmsyllabus.meijo-u.ac.jp/camweb/slbssbdr.do?value(risyunen)=2023&value(semekikn)=1&value(kougicd)=302306&value(crclumcd)=04141"
          />
          <CourseAccordion
          ...
          <CourseAccordion
            courseName="情報通信システム"
            instructors="複数名"
            syllabusLink="https://gkmsyllabus.meijo-u.ac.jp/camweb/slbssbdr.do?value(risyunen)=2023&value(semekikn)=1&value(kougicd)=302705&value(crclumcd)=04141"
          />
          <CourseAccordion
            courseName="数値解析"
            instructors="複数名"
        ...
        >
          ...
          <CourseAccordion
            courseName="ワイヤレス通信"
            instructors="複数名"
            syllabusLink="https://gkmsyllabus.meijo-u.ac.jp/camweb/slbssbdr.do?value(risyunen)=2023&value(semekikn)=1&value(kougicd)=302406&value(crclumcd)=04141"
          />
        </div>
      </div>
    </>
