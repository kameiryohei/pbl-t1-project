    ...
    <>
      ...
      <div style={{ display: "flex" }}>
        ...
        >
          ...
          <CourseAccordion
            courseName="ハードウェア記述言語"
            instructors="複数名"
            syllabusLink="https://gkmsyllabus.meijo-u.ac.jp/camweb/slbssbdr.do?value(risyunen)=2023&value(semekikn)=1&value(kougicd)=302706&value(crclumcd)=04141"
          />
          <CourseAccordion
            courseName="人工知能"
            instructors="複数名"
        ...
        >
          ...
          <CourseAccordion
            courseName="センサ工学"
            instructors="複数名"
            syllabusLink="https://gkmsyllabus.meijo-u.ac.jp/camweb/slbssbdr.do?value(risyunen)=2023&value(semekikn)=1&value(kougicd)=302401&value(crclumcd)=04141"
          />
          <CourseAccordion
            courseName="集積回路設計"
            instructors="複数名"
            syllabusLink="https://example.com/syllabus66"
          />
        </div>
      </div>
    </>
